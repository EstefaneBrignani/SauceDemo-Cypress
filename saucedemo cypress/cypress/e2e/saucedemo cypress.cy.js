...
describe('Cenario 02 AddToCard', () => {
  ...
  beforeEach(() => {
    ...
    //Então o usuário deve ser direcionado para a página de Cart 
    cy.url().should('eq','https://www.saucedemo.com/cart.html');
    cy.wait(2000)

    // E visualizar o item adicionado no carrinho
    })
    ...
    // E nao visualizar o item no carrinho
    })
...
describe('Cenario 03 Checkout', () => {
  ...
  beforeEach(() => {
    ...
    //E o usuário fot redirecionado para a página final
    cy.url().should('eq','https://www.saucedemo.com/checkout-complete.html');
    
    
    // Entao o usuario deve visualizar a mensagem 'THANK YOU FOR YOUR ORDER'
